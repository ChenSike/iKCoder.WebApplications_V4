...
var Scene = {};
var patternPoint = [0, 0, 4, 0, 4, 0, 8, 6.928, 8, 6.928, 4, 13.856, 4, 13.856, -4, 13.856, -4, 13.856, -8, 6.928, -8, 6.928, -4, 0, -4, 0, 4, 0]
...
Scene.initEnvironment = function (containerId) {
    ...
    Scene.Brush.setBuildBackgroundFn(function () {
        ...
        //正六边形---边长 = 8
        Scene.Brush.buildBackgroundLine(-4, 0, 4, 0, 4, '#919191');
		Scene.Brush.buildBackgroundLine(4, 0, 8, 6.928, 4, '#919191');
		Scene.Brush.buildBackgroundLine(8, 6.928, 4, 13.856, 4, '#919191');
		Scene.Brush.buildBackgroundLine(4, 13.856, -4, 13.856, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-4, 13.856, -8, 6.928,  4, '#919191');
        Scene.Brush.buildBackgroundLine(-8, 6.928, -4, 0,  4, '#919191');
...
Scene.StepCompleteFn = function (){
    ...
    if (actualLinePoint.length == '28' && ((patternPoint.sort(function(a,b){ return b-a}).toString() == actualLinePoint.sort(function(a,b){ return b-a}).toString()))){
        return true;
    }else{
        return false;
    }
