...
var Scene = {};
var patternPoint = [0, 0, 2, 0, 2, 0, 2, 3, 2, 3, -2, 3,-2, 3, -2, -2, -2, -2, 4, -2, 4, -2, 4, 5, 4, 5, -4, 5, -4, 5, -4, -4, -4, -4, 6, -4, 6, -4, 6, 7, 6, 7, -6, 7, -6, 7, -6, -6, -6, -6, 8, -6];
...
Scene.initEnvironment = function (containerId) {
    ...
    Scene.Brush.setBuildBackgroundFn(function () {
        ...
        //长方形 --- 长 = 5，宽 = 10
        Scene.Brush.buildBackgroundLine(0, 0, 2, 0, 4, '#919191');
        Scene.Brush.buildBackgroundLine(2, 0, 2, 3, 4, '#919191');
        Scene.Brush.buildBackgroundLine(2, 3, -2, 3, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-2, 3, -2, -2, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-2, -2, 4, -2, 4, '#919191');
        Scene.Brush.buildBackgroundLine(4, -2, 4, 5, 4, '#919191');
        Scene.Brush.buildBackgroundLine(4, 5, -4, 5, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-4, 5, -4, -4, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-4, -4, 6, -4, 4, '#919191');
        Scene.Brush.buildBackgroundLine(6, -4, 6, 7, 4, '#919191');
        Scene.Brush.buildBackgroundLine(6, 7, -6, 7, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-6, 7, -6, -6, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-6, -6, 8, -6, 4, '#919191');
...
Scene.StepCompleteFn = function (){
    ...
    if (actualLinePoint.length == '52' && ((patternPoint.sort(function(a,b){ return b-a}).toString() == actualLinePoint.sort(function(a,b){ return b-a}).toString()))){
        return true;
    }else{
        return false;
    }
