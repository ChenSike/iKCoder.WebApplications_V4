...
var Scene = {};
var patternPoint = [-15, 0, -11, 0, -11, 0, -11, 4, -11, 4, -7, 4, -7, 4, -7, 8, -7, 8, -3, 8, -3, 8, -3, 4, -3, 4, 1, 4, 1, 4, 1, 0, 1, 0, 5, 0];
...
Scene.initEnvironment = function (containerId) {
    ...
    Scene.Brush.setBuildBackgroundFn(function () {
        ...
        Scene.Brush.buildBackgroundLine(-11, 4, -7, 4, 4, '#919191');
        Scene.Brush.buildBackgroundLine( -7, 4, -7, 8, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-7, 8, -3, 8, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-3, 8, -3, 4, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-3, 4, 1, 4, 4, '#919191');
