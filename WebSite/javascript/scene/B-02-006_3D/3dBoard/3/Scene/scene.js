...
var Scene = {};
var patternPoint = [0, 0, 6, 0, 6, 0, 10.243, 4.243, 10.243, 4.243, 10.243, 10.243, 10.243, 10.243, 6, 14.485, 6, 14.485, 0, 14.485, 0, 14.485, -4.243, 10.243, -4.243, 10.243, -4.243, 4.243, -4.243, 4.243, 0, 0];
...
Scene.initEnvironment = function (containerId) {
    ...
    Scene.Brush.setBuildBackgroundFn(function () {
        ...
        Scene.Brush.buildBackgroundLine(6, 0, 10.243, 4.243, 4, '#919191');
        Scene.Brush.buildBackgroundLine(10.243, 4.243, 10.243,10.243, 4, '#919191');
        Scene.Brush.buildBackgroundLine(10.243, 10.243, 6, 14.485, 4, '#919191');
        Scene.Brush.buildBackgroundLine(6, 14.485, 0, 14.485, 4, '#919191');
        Scene.Brush.buildBackgroundLine(0, 14.485, -4.243, 10.243, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-4.243, 10.243, -4.243, 4.243,  4, '#919191');
        Scene.Brush.buildBackgroundLine(-4.243, 4.243, 0, 0,  4, '#919191');
...
Scene.StepCompleteFn = function (){
    ...
    if (actualLinePoint.length == '32' && ((patternPoint.sort(function(a,b){ return b-a}).toString() == actualLinePoint.sort(function(a,b){ return b-a}).toString()))){
        return true;
    }else{
        return false;
    }
