...
function IKCoderSenceRun_InitResources() {
	...
	IKCoderSenceRun_AddcollisonNode("candy1", 680, i_background_default_height - 250, sprite_pickup_candy1.width, sprite_pickup_candy1.height, true);
	
	var sprite_pickup_candy2 = IKCoderSenceRun_AddSprite(i_candy_img, -1, -1, 800, i_background_default_height - 421);
	i_spritesObjectsPool["sprite_pickup_candy2"] = sprite_pickup_candy2;
	IKCoderSenceRun_AddcollisonNode("candy2", 800, i_background_default_height - 421, sprite_pickup_candy2.width, sprite_pickup_candy2.height, true);
    ...
    IKCoderSenceRun_AddcollisonNode("candy3", 1080, i_background_default_height - 141, sprite_pickup_candy3.width, sprite_pickup_candy3.height, true);
