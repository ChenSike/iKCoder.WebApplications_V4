GAME.Explosion = function()
{
	...
	this.top = 	new ExplosionPartical("asplodeInner02.png"/*tpa=http://www.goodboydigital.com/runpixierun/js/game/asplodeInner02.png*/);
	this.bottom = new ExplosionPartical("asplodeInner01.png"/*tpa=http://www.goodboydigital.com/runpixierun/js/game/asplodeInner01.png*/);
	...
	for (var i=0; i < 5; i++) 
	{
		this.particals.push(new ExplosionPartical("asplodeSpike_01.png"/*tpa=http://www.goodboydigital.com/runpixierun/js/game/asplodeSpike_01.png*/));
		this.particals.push(new ExplosionPartical("asplodeSpike_02.png"/*tpa=http://www.goodboydigital.com/runpixierun/js/game/asplodeSpike_02.png*/));
	}
	...
	for (var i=0; i < 5; i++) 
	{
	 	var cloud = new PIXI.Sprite.fromFrame("dustSwirl.png"/*tpa=http://www.goodboydigital.com/runpixierun/js/game/dustSwirl.png*/);
