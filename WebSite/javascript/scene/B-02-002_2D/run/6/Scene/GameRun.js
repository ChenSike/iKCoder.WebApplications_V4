...
function IKCoderSenceRun_Begin() {
	...
	loader = new PIXI.AssetLoader([
	   ...
	   "javascript/scene/image/run/hud/pausedPanel.png",
	   "javascript/scene/image/run/hud/pixieRevised_controls.png",
	   "javascript/scene/image/run/hud/ContinuePlay.png",
	   "javascript/scene/image/run/hud/RestartPlay.png",
	   "javascript/scene/image/run/hud/pause.png",
	   "javascript/scene/image/run/hud/PersonalBest.png"
	]);
...
function init() {
	...
	black = new PIXI.Sprite.fromImage("javascript/scene/image/run/blackSquare.jpg");
	...
	personalBestTitle = PIXI.Sprite.fromImage("javascript/scene/image/run/hud/PersonalBest.png");
	...
	pauseButton = PIXI.Sprite.fromFrame("javascript/scene/image/run/hud/pause.png");
	...
	pauseScreen = PIXI.Sprite.fromImage("javascript/scene/image/run/hud/pausedPanel.png");
	...
	// Buttons
	resumeButton = PIXI.Sprite.fromImage("javascript/scene/image/run/hud/ContinuePlay.png");
	...
	restartButton = PIXI.Sprite.fromImage("javascript/scene/image/run/hud/RestartPlay.png");
...
function onTap(event) {
	...
	if (event.target.type !== 'button') {
		...
		if (gameMode === GAME_MODE.INTRO) {
			...
			logo.scale.x = 1.5;
			logo.scale.y = 1.5;
			logo.setTexture(PIXI.Texture.fromFrame("javascript/scene/image/run/hud/pixieRevised_controls.png"));
