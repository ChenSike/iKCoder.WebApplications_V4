...
function IKCoderSenceRun_Begin() {
   ...
   "javascript/scene/image/run/stone.fw.png"
	]);
...
function IKCoderSenceRun_InitResources() {
	...
	for (var index = 1; index <= i_countOfStones; index++) {
		IKCoderSenceRun_AddSprite('javascript/scene/image/run/stone.fw.png', -1, -1, 162 * index, i_background_default_height - 70);
	...
	var sprite_box_one = IKCoderSenceRun_AddSprite('javascript/scene/image/run/box.fw.png', -1, -1, 380, i_background_default_height - 150);
	...
	var sprite_pickup_candy = IKCoderSenceRun_AddSprite('javascript/scene/image/run/candy.fw.png', -1, -1, 1080, i_background_default_height - 141);
