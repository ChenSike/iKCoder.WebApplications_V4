...
function Game(id, params) {
    ...
    var _canvasDraw = document.getElementById(id);
    _canvasDraw.style.height = _.height; + "px";
    _canvasDraw.style.width = _.width; + "px";
    _canvasDraw.height = _.height;
    _canvasDraw.width = _.width;
    var _contextDraw = _canvasDraw.getContext('2d');
    ...
    this.start = function (fromInit) {
        ...
        var fn = function () {
            ...
            if (stage.update() != false) {
                ...
                _contextDraw.clearRect(0, 0, _canvasDraw.width, _canvasDraw.height);
                _contextDraw.drawImage($canvas, 0, 0);
            }
