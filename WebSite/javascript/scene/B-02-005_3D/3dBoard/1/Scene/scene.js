...
var Scene = {};
var patternPoint = [-15, 0, -10, 8.660,-10, 8.660, -5, 0,-5, 0, -15, 0];
...
Scene.initEnvironment = function (containerId) {
    ...
    Scene.Brush.setBuildBackgroundFn(function () {
        //等边三角形---边长 = 10
        Scene.Brush.buildBackgroundLine(-15, 0, -10, 8.660, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-10, 8.660, -5, 0, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-5, 0, -15, 0, 4, '#919191');
