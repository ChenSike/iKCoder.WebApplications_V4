...
var Scene = {};
var patternPointF = [-15, 0, -7, 0, -7, 0, -11, 6.928, -11, 6.928, -15, 0, -15, 0, -7, 0, -7, 0, 1, 0, 1, 0, -3, 6.928, -3, 6.928, -7, 0];
var patternPointS = [-15, 0, -7, 0, -7, 0, -11, 6.928, -11, 6.928, -15, 0, -15, 0, -7, 0, -7, 0, 1, 0, 1, 0, -3, 6.928, -3, 6.928, -7, 0, -7, 0, 1, 0];
...
Scene.StepCompleteFn = function (){
    ...
    if ((actualLinePoint.length == '28' && ((patternPointF.sort(function(a,b){ return b-a}).toString() == actualLinePoint.sort(function(a,b){ return b-a}).toString()))) || (actualLinePoint.length == '32' && ((patternPointS.sort(function(a,b){ return b-a}).toString() == actualLinePoint.sort(function(a,b){ return b-a}).toString()))) ){
        return true;
    }else{
        return false;
    }
