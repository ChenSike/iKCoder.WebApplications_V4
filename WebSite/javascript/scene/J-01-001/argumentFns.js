var argumentFn = [
    ...
    function (t, e, i) {
        ...
        var n = i(50),
            ...
            o = (i(34), function () {
                ...
                //this.teamA = [t.darwin, t.anais, t.princess_bubblegum],
                ...
                this.reset = function () {
                    var t = r;
                    this.teamA = [t.ben10, t.grup, t.fourarms],
                    this.teamB = [t.prohyas, t.vambre, t.ben10],
                    this.leftOverPlayers = [],
                    this.countryID = {
                        ID: "MEA",
            ...
            B = function (t) {
                function e(i) {
                    ...
                    return n.app = i, n.trackpad = new D({
                        ...
                        n.trackpad.snapTo = !0,
                        n.trackpad.scrollMax = 1 / 0,
                        n.trackpad.capMovement = !1,
                        n.trackpad.size = 306,
                        n.trackpad.maxSlots = 1 / 0,
                        n.trackpad.spring.springiness = .08,
                        n._onKeyDown = n.onKeyDown.bind(n),
                        n.transition = new L["default"](n.app),
                        n.title = A["default"].h1(""),
                        n.title.anchor.set(.5, .5),
                        n.addChild(n.title),
                        n.playersContainer = new c.Container,
                        n.addChild(n.playersContainer),
                        n.playersData = [], n
                }
                return a(e, t), e.prototype.setPlayers = function (t) {
                    ...
                    for (var i = 0; i < this.cards.length; i++)
                        this.cards[i].data && this.cards[i].data.selected,
                            this.cards[i].checkHide = !0,
                            this.cards[i].container.scale.set(0),
                            TweenLite.to(this.cards[i].container.scale, 1, {
                    ...
                    this.app.stage.children[2] = e,
                    this.app.stage.children[3] = t
        ...
        var o = i(16),
            ...
            a = function () {
                function t() {
                    ...
                    this.prev = new s["default"],
                    this.next = new s["default"],
                    this.relaseItems = new s["default"],
                    this.translateItems = new s["default"],
                    this.deltas = [0, 0, 0, 0, 0], this.off()
                }
    ...
    function (t, e, i) {
        ...
        r.prototype.run = function (t) {
            this.active = !0,
            this.left = t,
            this.game.movieBorders.show(.05, 1),
            this.game.flash.flash(),
            this.game.hud.party.visible = !0,
            this.game.world.view3d.camera.shake(30),
            this.game.world.view3d.camera.celebrateMode = !0,
            this.game.teamManagerA.left === t ? (this.game.teamManagerB.happy(), this.game.teamManagerA.sad()) : (this.game.teamManagerA.happy(), this.game.teamManagerB.sad()),
            this.game.hud.message.show(n.MESSAGE_ID.GOAL),
            this.game.wait.wait(150, function () {
        ...
        r.prototype.onFadeOut = function () {
            ...
            t.body.velocity.x = 0,
            t.body.velocity.y = 0,
            t.body.position.x = .5 * this.game.pitchWidth,
            t.body.position.y = .5 * this.game.pitchHeight,
            this.game.world.view3d.camera.celebrateMode = !1,
            this.game.hud.party.visible = !1,
            this.active && this.game.scripts.start.run(!1, this.left)
        },
