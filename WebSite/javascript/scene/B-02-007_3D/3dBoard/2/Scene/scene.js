...
var Scene = {};
var patternPoint = [-15, 0, -9, 0, -9, 0, -9, 6, -9, 6, -15, 6, -15, 6, -15, 0,-15, 0, -5, 0, -5, 0, 1, 0, 1, 0, 1, 6, 1, 6, -5, 6, -5, 6, -5, 0];
...
Scene.initEnvironment = function (containerId) {
    ...
    Scene.Brush.setBuildBackgroundFn(function () {
        //正方形---边长 = 6
        Scene.Brush.buildBackgroundLine(-15, 0, -9, 0, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-9, 0, -9, 6, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-9, 6, -15, 6, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-15, 6, -15, 0, 4, '#919191');
        //直线---长度 = 4
        Scene.Brush.buildBackgroundLine(-15, 0, -5, 0, 4, '#919191');
        //正方形---边长 = 6
        Scene.Brush.buildBackgroundLine(-5, 0, 1, 0, 4, '#919191');
        Scene.Brush.buildBackgroundLine(1, 0, 1, 6, 4, '#919191');
        Scene.Brush.buildBackgroundLine(1, 6, -5, 6, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-5, 6, -5, 0, 4, '#919191');
