...
function init() {
    ...
    renderer = new THREE.WebGLRenderer({ alpha: true, antialias: true, canvas: document.getElementById('canvas_BG_SignUp') });
    renderer.setSize(WIDTH, HEIGHT);
    renderer.shadowMapEnabled = true;
    container = document.getElementById('canvas_BG_SignUp');
