...
Engine.initCamera = function () {
    ...
    camera.position.x = Engine.params.camera.x;
    camera.position.y = Engine.params.camera.y;
    camera.position.z = Engine.params.camera.z;
...
Engine.initRender = function () {
    ...
    renderer.setClearColor(Engine.params.renderer.clearColor, Engine.params.renderer.clearAlpha);

    renderer.setSize(Engine.container.width(), Engine.container.height());
...
Engine.loop = function () {
    Engine._delta = Engine.clock.get_delta();
...
Engine.update_distance = function () {
    Engine._distance += Engine._delta * Engine.params.player.speed;
};
...
Engine.initModules = function () {
    Engine.modules['background'] = Engine.createFloor();
