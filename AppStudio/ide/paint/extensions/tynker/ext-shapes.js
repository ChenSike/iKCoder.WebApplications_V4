/*
 * ext-shapes: Shape tool, modified so as not to revert to select tool after shape is dragged in.
 *
 * Copyright(c) 2013 Tynker
 *
 * Based on original svg-edit ext-shapes.js
...
methodDraw.addExtension("tynker_shapes", function () {
    ...
    return {
        svgicons: "extensions/tynker/ext-shapes.xml",
        buttons: [{
            id: "tool_shapelib",
