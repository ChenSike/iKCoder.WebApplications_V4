...
Blockly.Blocks['positive_rotate_line'] = {
    init: function () {
        ...
        .appendField("旋转线段")
        .appendField(new Blockly.FieldDropdown([["30","30"], ["60","60"],["72","72"],["108","108"]]), "rotate_degree")
        .appendField(" 度 ")
        this.setNextStatement(true, null);
...
//            .appendField(new Blockly.FieldNumber(120, 1, 360, 1), "rotate_degree")
        .appendField(new Blockly.FieldDropdown([["30","30"], ["60","60"],["72","72"],["108","108"]]), "rotate_degree2")
        .appendField(" 度 ")
        this.setNextStatement(true, null);
        this.setPreviousStatement(true, null);
        this.setTooltip('');
...
Blockly.Blocks['lineLength'] = {
    init: function () {
		this.appendDummyInput()
				.appendField(new Blockly.FieldNumber(0,1,24,1), "line_length");
...
Blockly.JavaScript['lineLength'] = function (block) {
    return '';
};
