...
var Scene = {};
var patternPoint = [0, 0, 5, 0, 5, 0, 5, 10, 5, 10, 0, 10, 0, 10, 0, 0];
...
Scene.initEnvironment = function (containerId) {
    ...
    Scene.Brush.setBuildBackgroundFn(function () {
        ...
        //长方形 --- 长 = 5，宽 = 10
        Scene.Brush.buildBackgroundLine(0, 0, 5, 0, 4, '#919191');
        Scene.Brush.buildBackgroundLine(5, 0, 5, 10, 4, '#919191');
        Scene.Brush.buildBackgroundLine(5, 10, 0, 10, 4, '#919191');
