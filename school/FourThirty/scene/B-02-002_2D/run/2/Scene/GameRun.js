...
var i_PixiAssets_json = "fourthirty/image/run/PixiAssets-hd.json";
var i_shine_img = "fourthirty/image/run/shine.fw.png";
var i_candy_img = "fourthirty/image/run/candy.fw.png";
var i_box_img = "fourthirty/image/run/box.fw.png";
var i_stone_img = "fourthirty/image/run/stone.fw.png";
var i_ip4BGtile_img = "fourthirty/image/run/iP4_BGtile.jpg";
...
function IKCoderSenceRun_InitResources() {
	...
	IKCoderSenceRun_AddSprite(i_box_img, -1, -1, 380, i_background_default_height - 280);
	IKCoderSenceRun_AddcollisonNode("box_2", 380, i_background_default_height - 280, sprite_box_one.width, sprite_box_one.height, false);

	IKCoderSenceRun_AddSprite(i_box_img, -1, -1, 700, i_background_default_height - 150);
	IKCoderSenceRun_AddcollisonNode("box_3", 700, i_background_default_height - 150, sprite_box_one.width, sprite_box_one.height, false);


	IKCoderSenceRun_AddSprite(i_box_img, -1, -1, 700, i_background_default_height - 280);
	IKCoderSenceRun_AddcollisonNode("box_5", 700, i_background_default_height - 280, sprite_box_one.width, sprite_box_one.height, false);


	IKCoderSenceRun_AddSprite(i_box_img, -1, -1, 880, i_background_default_height - 421);
	...
	var sprite_pickup_candy = IKCoderSenceRun_AddSprite(i_candy_img, -1, -1, 1080, i_background_default_height - 141);
