...
Blockly.JavaScript['draw_graph'] = function (block) {
    return 'Draw_Graph();\n';
};

Blockly.Blocks['draw_graph_function'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("函数    画图形");
    this.appendStatementInput("do")
...
Blockly.JavaScript['draw_graph_function'] = function(block) {
     var statements_do = Blockly.JavaScript.statementToCode(block, 'do');
     var code = 'function Draw_Graph()\n {\n' + statements_do + ' \n};\n';
    return code;
};
