...
var Scene = {};
var patternPoint = [0, 0, 4, 0, 4, 0, 4, 4, 4, 4, 0, 4,0, 4, 0, 0, 0, 0, 6, 0, 6, 0, 6, -6, 6, -6, 0, -6, 0, -6, 0, 0, 0, 0, -8, 0, -8, 0, -8, -8, -8, -8, 0, -8, 0, -8, 0, 0, 0, 0, -10, 0, -10, 0, -10, 10, -10, 10, 0, 10, 0, 10, 0, 0];
...
Scene.initEnvironment = function (containerId) {
    ...
    Scene.Brush.setBuildBackgroundFn(function () {
        //4个正方形---边长 = 4， 6， 8，10
        Scene.Brush.buildBackgroundLine(0, 0, 4, 0, 4, '#919191');
        Scene.Brush.buildBackgroundLine(4, 0, 4, 4, 4, '#919191');
        Scene.Brush.buildBackgroundLine(4, 4, 0, 4, 4, '#919191');
        Scene.Brush.buildBackgroundLine(0, 4, 0, 0, 4, '#919191');
//        0, 0, 4, 0, 4, 0, 4, 4, 4, 4, 0, 4,0, 4, 0, 0, 0, 0, 6, 0, 6, 0, 6, -6, 6, -6, 0, -6, 0, -6, 0, 0, 
        Scene.Brush.buildBackgroundLine(0, 0, 6, 0, 4, '#919191');
        Scene.Brush.buildBackgroundLine(6, 0, 6, -6, 4, '#919191');
        Scene.Brush.buildBackgroundLine(6, -6, 0, -6, 4, '#919191');
        Scene.Brush.buildBackgroundLine(0, -6, 0, 0, 4, '#919191');

        Scene.Brush.buildBackgroundLine(0, 0, -8, 0, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-8, 0, -8, -8, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-8, -8, 0, -8, 4, '#919191');
        Scene.Brush.buildBackgroundLine(0, -8, 0, 0, 4, '#919191');
        //0, 0, -8, 0, -8, 0, -8, -8, -8, -8, 0, -8, 0, -8, 0, 0, 
        Scene.Brush.buildBackgroundLine(0, 0, -10, 0, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-10, 0, -10, 10, 4, '#919191');
        Scene.Brush.buildBackgroundLine(-10, 10, 0, 10, 4, '#919191');
        Scene.Brush.buildBackgroundLine(0, 10, 0, 0, 4, '#919191');
...
Scene.StepCompleteFn = function (){
    ...
    if (actualLinePoint.length == '64' && (patternPoint.sort(function(a,b){ return b-a}).toString() == actualLinePoint.sort(function(a,b){ return b-a}).toString())) {
        return true;
    }else{
        return false;
    }
