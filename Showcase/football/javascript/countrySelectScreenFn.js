    ...
    var h = i(8),
        ...
        L = (n(C), function (t) {
            function e(i) {
                ...
                n.scaleRatio = .8,
                n.blocked = !1,
                n.bg = l.Sprite.from(URL_HEADER.IMAGE + "ui/country-select-panel.png"),
                n.bg.anchor.set(.5, .5),
                n.addChild(n.bg),
                n.title = v["default"].h1(M.Translation.country_select_screen.title),
                n.title.anchor.set(.5, .5),
                n.addChild(n.title),
                n.flagsContainer = new l.Container,
                n.flagsContainer.scale.set(n.scaleRatio),
                n.bg.addChild(n.flagsContainer),
                n.countries = (0, M.getCountries)(),
                n.buttonList = [];
                ...
                return n.bgc = new l.Graphics,
                    n.bgc.beginFill(4095 * Math.random()),
                    n.bgc.drawRect(0, 0, n.flagsContainer.width, n.flagsContainer.height),
                    n.flagsContainer.position.set(-n.flagsContainer.width / 2 + a.width / 2 - T["default"].COUNTRY_SELECT.MARGIN / 2, -n.flagsContainer.height / 2 + a.height / 2 - T["default"].COUNTRY_SELECT.MARGIN / 2),
                    n.countryGroup = new d["default"](n.buttonList, 1),
                    n.toolTip = new m["default"],
                    n.bg.addChild(n.toolTip),
                    n.toolTip.onDown.add(n.onCountryButtonPressed.bind(n)),
                    n.hoverDebounce = 0,
                    n
            }
            return a(e, t),
            ...
            e.prototype.getRank = function (t) {
                ...
                e.prototype.onShow = function () {
                    this.app.topMenu.buttons.prev.hide();
                    this.toolTip.hide(),
                        this.blocked = !1,
