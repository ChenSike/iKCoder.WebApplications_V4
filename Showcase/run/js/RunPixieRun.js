...
function onStressTestComplete() {
	...
	loader = new PIXI.AssetLoader([
        "run/img/stretched_hyper_tile.jpg",
        "run/img/SplashAssets.json",
        "run/img/WorldAssets-hd.json",
        "run/img/HudAssets-hd.json",
        "run/img/PixiAssets-hd.json",
        "run/img/iP4_BGtile.jpg",
        "run/img/blackSquare.jpg",
        "run/assets/hud/pausedPanel.png",
        "run/assets/hud/pixieRevised_controls.png",
        "run/assets/hud/ContinuePlay.png",
        "run/assets/hud/RestartPlay.png",
        "run/assets/hud/soundOff.png",
        "run/assets/hud/soundOn.png",
        "run/assets/hud/pause.png",
        "run/assets/hud/PersonalBest.png"
...
function onTap(event) {
	...
	if (event.target.type !== 'button') {
		...
		if (gameMode === GAME_MODE.INTRO) {
			...
			logo.scale.x = 1.5;
			logo.scale.y = 1.5;
			logo.setTexture(PIXI.Texture.fromFrame("run/assets/hud/pixieRevised_controls.png"));
...
function init() {
	...
	personalBestTitle = PIXI.Sprite.fromImage("run/assets/hud/PersonalBest.png");
	...
	pauseButton = PIXI.Sprite.fromFrame("run/assets/hud/pause.png");
	...
	pauseScreen = PIXI.Sprite.fromImage("run/assets/hud/pausedPanel.png");
	...
	// Buttons
	resumeButton = PIXI.Sprite.fromImage("run/assets/hud/ContinuePlay.png");
	...
	restartButton = PIXI.Sprite.fromImage("run/assets/hud/RestartPlay.png");
	...
	soundOffButton = PIXI.Sprite.fromImage("run/assets/hud/soundOff.png");
	...
	soundOnButton = PIXI.Sprite.fromImage("run/assets/hud/soundOn.png");
