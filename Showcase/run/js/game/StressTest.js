...
PIXI.StressTest = function(callback)
{
    ...
    this.tick = 0;
    this.loadingFrames = [
        "run/img/loading_01.png",
        "run/img/loading_02.png",
        "run/img/loading_03.png",
        "run/img/loading_04.png"
    ];
    ...
    var scope = this;
    this.texture = PIXI.Texture.fromImage("run/img/testImage.png");
...
PIXI.StressTest.prototype.begin = function()
{
    ...
    var logo = new PIXI.Sprite(PIXI.Texture.fromImage('run/img/ikCoder_logo.png'));
        logo.anchor.x = 0.5;
        logo.anchor.y = 0.5;
