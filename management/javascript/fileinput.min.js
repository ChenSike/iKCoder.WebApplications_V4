...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="fa fa-lg fa-file"></i>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<i class="fa fa-lg fa-trash"></i>',
                    removeClass: 'btn btn-kv btn-default btn-outline-secondary',
                    removeErrorClass: 'btn btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="fa fa-lg fa-upload "></i>',
                    uploadClass: 'btn btn-kv btn-default btn-outline-secondary',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="fa fa-lg fa-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="fa fa-lg fa-download"></i>',
                    downloadClass: 'btn btn-kv btn-default btn-outline-secondary',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="fa fa-lg fa-search-plus"></i>',
                    zoomClass: 'btn btn-kv btn-default btn-outline-secondary',
                    zoomTitle: 'View Details',
                    dragIcon: '<i class="fa fa-lg fa-move"></i>',
                    dragClass: 'text-info',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="fa fa-lg fa-plus-sign text-warning"></i>',
                    indicatorSuccess: '<i class="fa fa-lg fa-ok-sign text-success"></i>',
                    indicatorError: '<i class="fa fa-lg fa-exclamation-sign text-danger"></i>',
                    indicatorLoading: '<i class="fa fa-lg fa-hourglass text-muted"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="fa fa-lg fa-triangle-left"></i>',
            next: '<i class="fa fa-lg fa-triangle-right"></i>',
            toggleheader: '<i class="fa fa-lg fa-arrows-v"></i>',
            fullscreen: '<i class="fa fa-lg fa-arrows-alt"></i>',
            borderless: '<i class="fa fa-lg fa-expand"></i>',
            close: '<i class="fa fa-lg fa-remove"></i>'
        },
        ...
        customLayoutTags: {},
        customPreviewTags: {},
        previewFileIcon: '<i class="fa fa-lg fa-file"></i>',
        ...
        cancelIcon: '<i class="fa fa-lg fa-ban-circle"></i>',
        ...
        msgValidationErrorIcon: '<i class="fa fa-lg fa-exclamation-sign"></i> ',
